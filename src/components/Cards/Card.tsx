...
const Card = ({duration, imageUrl, title, position, type, link}: ICardProps) => {
    ...
    return <Link to={link}>
        <motion.div className={styles.wrapper}
                    ...
                    animate={{ padding: 0, marginRight: '30px'}}
        >
            <motion.div
            ...
            <p
                      className={styles.date}>{`${duration.from.format('D MMMM')} - ${duration.to.format('D MMMM')}`}</p>
            ...
            <p className={styles.position}>
                <motion.svg width="10" height="12" viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <motion.circle cx="5" cy="5" r="5" animate={{fill: !hover ? "#53565A" : '#53565A'}}/>
                    {/*<motion.path d="M5 12L1 8H9L5 12Z" animate={{fill: !hover ? "#53565A" : 'white'}}/>*/}
                    <motion.path d="M5 12L1 8H9L5 12Z" animate={{fill: !hover ? "#53565A" : '#53565A'}}/>
                    {/*<motion.circle cx="5" cy="5" r="2" animate={{fill: !hover ? "white" : '#53565A'}}/>*/}
                    <motion.circle cx="5" cy="5" r="2" animate={{fill: !hover ? "white" : 'white'}}/>
                </motion.svg>
